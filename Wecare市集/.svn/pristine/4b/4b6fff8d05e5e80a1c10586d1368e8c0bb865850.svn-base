...
namespace App3__Win_8._1_
{
    ...
    public sealed partial class GroupedItemsPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            //this.BMI.Margin = new Thickness(this.Width-this.BMI.Width, 40, 0, 28);
        }
        ...
        void Header_Click(object sender, RoutedEventArgs e)
        {
            ...
            // 巡覽至適用的目的頁面，設定新的頁面
            // 方式是透過傳遞必要資訊做為巡覽參數
            this.Frame.Navigate(typeof(GroupDetailPage), ((Divisions)group).UniqueId);
        }
        ...
        {
            string Title="我的BMI";
            this.Frame.Navigate(typeof(BMI), Title);
        }
    }
}
...
namespace MyClassLibrary
{
    public class ClsChartReport2
    {
        ...
        public void CreatPie(Chart chart1)
        {
            chart1.Visible = true;
        ...
        public void CreatBar(Chart chart1)
        {
            chart1.Visible = true;
            //chart2.Visible = false;
            chart1.Series[0].ChartType = SeriesChartType.Column;
            //chart1.Titles[0].Text = "檢驗提醒使用率";
        ...
        public void CreatSexchart(Chart chart2)
        {
            ...
            foreach (MedDataSet.PatientsRow r in meddataset.Patients.Rows)
            {
                if (Men == r.Ptt_Sex)
                {
                    if (whichitem == "檢驗")
                    {
                        chart2.Titles[0].Text = "檢驗提醒 VS. 性別";
                        if (r.Ptt_ExamRmd)
                        {
                            yesmen++;
                        }
                    ...
                    if (whichitem == "用藥")
                    {
                        chart2.Titles[0].Text = "用藥提醒 VS. 性別";
                        if (r.Ptt_DrugRmd)
                        {
                            yesmen++;
                        }
        ...
        public void CreatAgechart(Chart chart2)
        {
            //chart1.Visible = false;
            chart2.Visible = true;
            chart2.ChartAreas[0].AxisX.MajorGrid.LineWidth = 0;  //取消X軸隔線
            ...
            if (whichitem == "檢驗")
            {
                chart2.Titles[0].Text = "檢驗提醒 VS. 年齡";
            ...
            if (whichitem == "用藥")
            {
                chart2.Titles[0].Text = "用藥提醒 VS. 年齡";
                t2Yes = (from m in meddataset.Patients
        ...
        public void DrugUserate(Chart chart1)
        {
            whichitem = "用藥";
            chart1.Visible = true;
            //chart2.Visible = false;
            ...
            chart1.Series[0].YValueMembers = "falsekey";
            //chart1.Series[0].ChartType = SeriesChartType.Pie;
            chart1.Titles[0].Text = "用藥提醒使用率";
            chart1.Series[0].IsValueShownAsLabel = true;
            //chart1.Series[0].LegendText = "#AXISLABEL: [ #PERCENT{P0} ]"; //X軸 + 百分比
            //chart1.Series[0].Label = "#AXISLABEL\n#PERCENT{P0}";
        }
        public void ExamCloserate(Chart chart1)
        {
            whichitem = "檢驗結案";
            chart1.Visible = true;
            //chart2.Visible = false;
        ...
        public void DrugCloserate(Chart chart1)
        {
            whichitem = "用藥結案";
            chart1.Visible = true;
            //chart2.Visible = false;
